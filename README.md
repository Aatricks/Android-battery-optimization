...
(for samsung) freeze or disable device care, and in the adb force the power saving mode on (given we don't have it without device care) by using the Samsung Specific Optimizations in the optimizer script.
